...
def loi():
	print ('\033[1;34mLỗi: Bạn Chưa Mua \033[1;31mVIP')
	print ('\033[1;34mVui Lòng Liên Hệ 𝑫𝒐𝒂𝒏 𝑽𝒂𝒏 𝑿𝒖𝒂𝒏 𝑸𝒖𝒚𝒆𝒏 𓆏𓆤 3:) ②⓪⓪⑧ !!! Để Đc Hỗ Trợ')
	print ('https://m.facebook.com/dvx.quyen.208')
def cac():
  print ("\033[1;36m⛏️Đang Đào...")
def clear():
...
def fakeEmail():
  faker = Faker()
  print ('')
  print ('             \033[1;34m〘 Tool By 𝑫𝒐𝒂𝒏 𝑽𝒂𝒏 𝑿𝒖𝒂𝒏 𝑸𝒖𝒚𝒆𝒏 𓆏𓆤 3:) ②⓪⓪⑧ !!!a 〙')
  print ('')
  data_kytu = ['', '_', '.']
  so_luong = int(input("╼\033[1;35m❯\033[1;36m❯\033[1;31m❯ Nhập Số Lượng=> "))
  Domain = input("╼\033[1;35m❯\033[1;36m❯\033[1;31m❯ Nhập Domain=> ")
  file_email = input("╼\033[1;35m❯\033[1;36m❯\033[1;31m❯ Nhập Tên File Để Lưu Email=>> ")
  n = 0
  for fake in range(so_luong):
    ...
    print (" [" + str(n) + "] ╼\033[1;35m❯\033[1;36m❯\033[1;31m❯ \033[1;91m〘\033[1;92mDvx𓊗‏\033[1;96mQu\033[1;93my\033[1;97mền\033[1;91m〙\033[1;33m" + fake_email)
...
def checkhotmail():
  ...
  print ('')
  try:
    print ("╼ \033[1;35m❯\033[1;36m❯\033[1;31m❯ \033[1;34mTool By 𝑫𝒐𝒂𝒏 𝑽𝒂𝒏 𝑿𝒖𝒂𝒏 𝑸𝒖𝒚𝒆𝒏 𓆏𓆤 3:) ②⓪⓪⑧ !!!")
    hotmail = open(input("╼\033[1;35m❯\033[1;36m❯\033[1;31m❯ Nhập File Chứa Hotmail=> ")).readlines()
    hotmail_die = input("╼\033[1;35m❯\033[1;36m❯\033[1;31m❯ Nhập Tên File Để Lưu Hotmail Có Thể Reg=> ")
    hotmail_live = input("╼\033[1;35m❯\033[1;36m❯\033[1;31m❯ Nhập Tên File Lưu Hotmail Đã Tồn Tại=> ")
  except:
    print (" \033[1;31m LỖI: BẠN NHẬP FILE KO ĐÚNG❌")
    process_menu()
  list_hotmail = []
  ...
  def run_check_hotmail(hot_mail):
    ...
    if kq == None:
      print ("╼\033[1;35m❯\033[1;36m❯\033[1;31m❯ \033[1;91m〘\033[1;92mDvx𓊗‏\033[1;96mQu\033[1;93my\033[1;97m ền\033[1;91m〙\033[1;31m Email Này Đã Tồn Tại-> " + hot_mail + "@hotmail.com")
      open(hotmail_live,'a').write(hot_mail + "@hotmail.com" + "\n")
    else:
      print ("╼\033[1;35m❯\033[1;36m❯\033[1;31m❯ \033[1;91m〘\033[1;92mDvx𓊗‏\033[1;96mQu\033[1;93my\033[1;97mền\033[1;91m〙\033[1;32m Email Này Có Thể Reg-> " + hot_mail + "@hotmail.com")
...
def checkyahoo():
  ...
  print ("")
  try:
    print (" ╼\033[1;35m❯\033[1;36m❯\033[1;31m❯ \033[1;34m TOOL By𝑫𝒐𝒂𝒏 𝑽𝒂𝒏 𝑿𝒖𝒂𝒏 𝑸𝒖𝒚𝒆𝒏 𓆏𓆤 3:) ②⓪⓪⑧ !!!")
    n_yahoo = 0
    yahoo = open(input("╼\033[1;35m❯\033[1;36m❯\033[1;31m❯ Nhập Tên File Chứa Yahoo=> ")).readlines()
    yahoo_die = input("╼\033[1;35m❯\033[1;36m❯\033[1;31m❯ Nhập Tên File Lưu Yahoo Có Thể Reg=> ")
    yahoo_live = input("╼\033[1;35m❯\033[1;36m❯\033[1;31m❯ Nhập Tên File Lưu Yahoo Đã Tồn Tại=> ")
  except:
    print (" \033[1;31m LỖI: BẠN NHẬP FILE KO ĐÚNG❌")
    process_menu()
  list_yid = []
  ...
  def run_check_yahoo(yid):
    ...
    if KQ == None:
      print("╼\033[1;35m❯\033[1;36m❯\033[1;31m❯ \033[1;91m〘\033[1;92mDvx𓊗‏\033[1;96mQu\033[1;93my\033[1;97mền\033[1;91m〙\033[1;32m Email Này Có Thể Reg-> " + yid + "@yahoo.com")
      open(yahoo_die,"a").write(yid + "@yahoo.com" + "\n")
    else:
      print("╼\033[1;35m❯\033[1;36m❯\033[1;31m❯ \033[1;91m〘\033[1;92mDvx𓊗‏\033[1;96mQu\033[1;93my\033[1;97mền\033[1;91m〙\033[1;31m Email Này Đã Tồn Tại-> " + yid + "@yahoo.com")
...
def checkvalid():
  print ('')
  print ('             \033[1;34m〘 Tool Check Email Liên Kết Facebook🔗 〙')
  print ('')
  try:
    print ('\033[1;32mNẾU TOOL BỊ KO LIÊN KẾT VỚI CÓ LIÊN KẾT NHIỀU LẦN LÀ BẠN ĐÃ BỊ BLOCK IP')
    print ('\033[1;34mBẠN PHẢI FAKE IP LIÊN TỤC ĐỂ CHẠY TIẾP CÒN MUỐN DỪNG THÌ Crtl+z')
    fileEmail = open(input("╼\033[1;35m❯\033[1;36m❯\033[1;31m❯  Nhập Tên File Chứa Email=> ")).readlines()
    valid = input("╼\033[1;35m❯\033[1;36m❯\033[1;31m❯  Nhập File Lưu Email Đã Đk Facebook=> ")
  except:
    print (" \033[1;31m LỖI: BẠN NHẬP FILE KO ĐÚNG❌")
    process_menu()
  list_email_fb = []
  ...
  def run_check_valid(emailfb):
    ...
    if kq_check == None:
      print ("╼\033[1;35m❯\033[1;36m❯\033[1;31m❯ \033[1;91m〘\033[1;92mDvx𓊗‏\033[1;96mQu\033[1;93my\033[1;97mền\033[1;91m〙\033[1;32m Có Liên Kết FB-> " + emailfb)
      open(valid,"a").write(emailfb + "\n")
    else:
      print ("╼\033[1;35m❯\033[1;36m❯\033[1;31m❯ \033[1;91m〘\033[1;92mDvx𓊗‏\033[1;96mQu\033[1;93my\033[1;97mền\033[1;91m〙\033[1;31m Không Liên Kết FB-> " + emailfb)
  with concurrent.futures.ThreadPoolExecutor() as executor:
...
def logo():
  logo = """
            ...
            \033[1;93m░░█░░ █░░█ █░░█ █░░   \033[1;34m█░▀░█ █▄▄█ ▀█▀ █░░
            \033[1;36m░░▀░░ ▀▀▀▀ ▀▀▀▀ ▀▀▀   \033[1;35m▀░░░▀ ▀░░▀ ▀▀▀ ▀▀▀
              ╼\033[1;35m❯\033[1;36m❯\033[1;31m❯\033[1;34m Copyright By : 𝑫𝒐𝒂𝒏 𝑽𝒂𝒏 𝑿𝒖𝒂𝒏 𝑸𝒖𝒚𝒆𝒏 𓆏𓆤 3:) ②⓪⓪⑧ !!!
              ╼\033[1;35m❯\033[1;36m❯\033[1;31m❯\033[1;33m Zalo : zalo.me/quyentrumtool
              ╼\033[1;35m❯\033[1;36m❯\033[1;31m❯\033[1;32m Facebook : https://m.facebook.com/dvx.quyen.208
"""
...
def process_menu():
  menu = """
                ...
                \033[1;31m[-----------------------------]
                      \033[1;36m〘1〙Đào Mail📧⛏️
                      \033[1;32m〘2〙Check Hotmail🔥
                      \033[1;33m〘3〙Check Yahoo💜
                      \033[1;34m〘4〙Check Email Liên Kết Facebook🔗
                      \033[1;37m〘5〙Đào Mail India\033[1;30m [VIP]
                      \033[1;35m〘6〙Thoát Tool🚫
                \033[1;31m[-----------------------------]
...
"""
  for letter in menu:
  	...
  	sys.stdout.flush()
  	time.sleep(0.001)
  print ("\033[1;34m┌➻❥〘\033[1;37m\033[1;42m Nhập Chế Độ Muốn Dùng !! \033[0m\033[1;34m〙")
  choice_user = input ("└──╼\033[1;35m❯\033[1;36m❯\033[1;31m❯ ")
  if choice_user == '1':
    clear()
    fakeEmail()
  if choice_user == '2':
  ...
  if choice_user == '5':
    clear()
    print ("\033[1;34mĐã Tự Động Chọn Domain Yahoo")
    time.sleep(1)
    clear()
    print ("\033[1;35mVào Tool Sau---> 3s")
    time.sleep(1)
    clear()
    print ("\033[1;35mVào Tool Sau---> 2s")
    time.sleep(1)
    clear()
    print ("\033[1;35mVào Tool Sau---> 1s")
    time.sleep(0.5)
    clear()
    print ("\033[1;35mĐang Check VIP.")
    time.sleep(0.5)
    clear()
    print ("\033[1;35mĐang Check VIP..")
    time.sleep(0.5)
    ...
    time.sleep(1)
    clear()
    print ("\033[1;37mĐang Tiến Hành Quá Trình...")
    time.sleep(1)
    print ("\033[1;32m✓")
    time.sleep(1)
    clear()
    print ("\033[1;91mBắt Đầu -->")
    time.sleep(1)
    cac()
    time.sleep(2)
    print ("Đã Đào Được 2597 Mail✓")
    time.sleep(1)
    print ("Đang Lưu Mail...")
    time.sleep(2)
    loi()
  ...
  if choice_user == '6':
    clear()
    print (" \033[1;92mTool  By 𝑫𝒐𝒂𝒏 𝑽𝒂𝒏 𝑿𝒖𝒂𝒏 𝑸𝒖𝒚𝒆𝒏 𓆏𓆤 3:) ②⓪⓪⑧ !!!\033[1;34m</>\033[1;96mĐã Out Tool")
    quit()
  if choice_user != '1' or '2' or '3' or '4' or '5' or '6':
    process_menu()
  if choice_user == '':
    process_menu()
logo() 
